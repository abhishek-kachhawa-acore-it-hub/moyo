...
class _SettingScreenState extends State<SettingScreen>
  ...
  Future<void> _navigateToLegalDocument(String documentType) async {
    final prefs = await SharedPreferences.getInstance();
final String role = prefs.getString('user_role') ?? 'customer';
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            TermsandConditions(type: documentType, roles: [role]),
      ),
    );
  }
  ...
  Future<void> _shareApp() async {
    try {
      ...
      final ByteData bytes = await rootBundle.load('assets/icons/app_icon.png');
